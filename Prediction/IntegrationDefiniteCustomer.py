...
#functions for measuring query latency
def start_timer():
...
def all_products(orderedNeighbours, onto, active_product, productDF):
    ...
    maxAllowablePrice=1.5*activeProductPrice
    ...
    for element in productList: 
        ...
        elif(float(elementPrice)> float(maxAllowablePrice)):
            newProductList.append(element)
...
def run_recommendation_for_input(personOfInterest, productOfInterest):
    ...
    #(minPriceActiveUser, maxPriceActiveUser)
    ...
    print("all the products are printed above")
...
# #QueryLatency - was satrted just before module ran
# QueryLatency = stop_timer(timestamp)
# print("Query Latency:")
# print(QueryLatency,"ms")

# Query Latency:
# 4426.090240478516 ms
...
# Data has been reset
# [[['B00000I1BJ'], ['Resident Evil 2'], ['229.99']], [['B00000DMAT'], ['GoldenEye 007'], ['249.99']], [['B00000I1BY'], ["Resident Evil: Director's Cut"], ['143.95']]]
...
# The list of all products purchased by all neighbours has been created 
# Data has been reset
# [[['076700941X'], ['Upstairs Downstairs - The Fourth Season VHS'], ['15.46']], [['0767001311'], ['The Very Best of the Bob Newhart Show 6 VHS'], ['22.99']], [['0764003828'], ['Take the Money and Run VHS'], ['14.95']]]
# [[['076700941X'], ['Upstairs Downstairs - The Fourth Season VHS'], ['15.46']], [['0767001311'], ['The Very Best of the Bob Newhart Show 6 VHS'], ['22.99']], [['0764003828'], ['Take the Money and Run VHS'], ['14.95']]]
...
# #Case 5 : No costlier product --- should be filler line
# allProductsInfoList = run_recommendation_for_input('A8NHN9UPML858', 'B000003SQQ')
# print(allProductsInfoList)
# 
# 
# The product and reviewer dataframes have been loaded
...
# The list of all products purchased by all neighbours has been created 
# Data has been reset
# [[['0975277324'], ['Days of Wonder Ticket To Ride'], ['44.97']]]
